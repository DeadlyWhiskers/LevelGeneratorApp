...
// Верисия для глобального эксперимента
const GenerationSettingsExperiment = ({className, children}: GenerationSettingsProps) => {
    return (
        <InfoBlock className={`${className}`} childrenClassName='h-full flex-col'>
            <BasicRow>
...
export default GenerationSettingsExperiment;